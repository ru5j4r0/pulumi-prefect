module github.com/ru5j4r0/pulumi-prefect/provider
...
replace (
	...
	github.com/prefecthq/terraform-provider-prefect/shim => ./shim
)

require (
	github.com/prefecthq/terraform-provider-prefect/shim v0.0.0
...
require (
	...
	github.com/prefecthq/terraform-provider-prefect v0.1.4 // indirect
