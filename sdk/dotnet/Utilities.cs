...
namespace Pulumi.Prefect
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/ru5j4r0/pulumi-prefect/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Prefect.version.txt");
    ...
    internal sealed class PrefectResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PrefectResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
